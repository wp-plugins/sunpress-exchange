...
function sunpress_exchange_block($rss) {
    global $post;
...
function sunpress_exchange_compact_block($rss,$blocktitle) {
    global $post;
		include_once(ABSPATH . WPINC . '/rss.php');
            ...
            if ($default_currency!="gbp") {
                ...
                foreach ($rss->items as $item) {
                    if ($counter < 6) {
                            ...
                            $rsstitle = $item['title'];
                						$rsstitle = str_replace("&", "&amp;",$rsstitle);
                						$rssdescription = "<strong>from just ".$currency.number_format($newprice,2)."pp</strong>";
                            $rssurl = $item['link'];
        						...
        						if ($sub == "holidays") {
    										echo "<li><a href='".$rssurl."' title='".$rsstitle."'>".$rsstitle."</a> ".$rssdescription." (inc flights)</li>";
										} elseif ($sub == "hotels") {
    										echo "<li><a href='".$rssurl."' title='".$rsstitle."'>".$rsstitle."</a> ".$rssdescription." (hotel only)</li>";
										} elseif ($sub == "flights") {
    										echo "<li><a href='".$rssurl."' title='".$rsstitle."'>".$rsstitle."</a> ".$rssdescription." (flights only)</li>";
										}
