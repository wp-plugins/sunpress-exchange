...
Version 1.1 converts UK airport IATA codes into readable names (e.g. MAN becomes Manchester Airport). 
...
4. In your template file for single.php, paste "<?php sunpress_exchange_block(); ?>" where you want the block to appear; probably directly after "the_content..."
